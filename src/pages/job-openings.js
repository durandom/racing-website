...
const JobOpenings = () => {
  ...
  return (
    <>
      ...
      >
        <div className="inner-banner bg-default-6 pt-24 pt-lg-24 pb-lg-5 pb-15">
          <Container>
              ...
              <Col xl="8" lg="9">
                <div className="px-md-12 mb-13 text-center">
                  ...
                  <p className="gr-text-8 mb-0 text-color-opacity">
                    The core #B4mad team is responsible for the direction of the products and the platform. We are a
                    globally distributed group of motorsports and technology enthusiasts who are passionate about
                    combining the two. If you think you are like us, we may have an opportunity for you.
                  </p>
                </div>
              </Col>
            </Row>
        ...
        {/* <JobVideo/> */}
        <div className="py-10 py-lg-10 bg-default-6 ">
          <Container>
        ...
        <div className="bg-default-2 py-10 py-lg-10">
          <Container>
            <div className="section-title text-center mb-13 mb-lg-20">
              <h2 className="gr-text-3 mb-0 heading-color">Current openings</h2>
            </div>
            <Row>
              <Col xs="12">
